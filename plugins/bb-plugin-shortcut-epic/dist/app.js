  ...
  const content = /* @__PURE__ */ jsxs(Fragment2, { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        node.blocked && node.isActive ? /* @__PURE__ */ jsx("span", { className: "rounded-full bg-destructive/10 px-1.5 py-0.5 text-[10px] font-medium text-destructive", children: "Blocked" }) : null,
        /* @__PURE__ */ jsx(
          "span",
          {
            className: cn(
...
function Count({ label, value, tone }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1.5", children: [
    /* @__PURE__ */ jsx("span", { className: cn("text-sm font-semibold", tone && statusClass(tone).split(" ")[1]), children: value }),
...
function EpicGraph() {
  ...
  if (!data && error) {
    return /* @__PURE__ */ jsx("div", { className: "flex h-full items-center justify-center p-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-lg rounded-lg border border-destructive/30 bg-destructive/5 p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 font-medium text-destructive", children: [
        /* @__PURE__ */ jsx(Icon, { name: "AlertTriangle", "aria-hidden": "true" }),
  ...
  const warnings = [
    ...data.warnings,
    ...layout.cyclicNodeIds.length > 0 ? [`Dependency cycle detected among Stories ${layout.cyclicNodeIds.join(", ")}.`] : []
  ];
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-0 flex-col bg-background", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-x-6 gap-y-3 border-b border-border px-4 py-3 md:px-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "truncate text-sm font-medium", children: data.epic.name }),
          /* @__PURE__ */ jsxs("span", { className: "shrink-0 font-mono text-xs text-muted-foreground", children: [
            "epic-",
            data.epic.id
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-0.5 truncate text-xs text-muted-foreground", children: [
          data.project.name,
          " \xB7 ",
          data.configPath,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx(Count, { label: "active", value: data.counts.active, tone: "active" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            disabled: loading,
            onClick: () => void load(),
            children: /* @__PURE__ */ jsx(Icon, { name: "RotateCcw", className: cn(loading && "animate-spin"), "aria-hidden": "true" })
          }
        )
      ] })
    ] }),
    error || warnings.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "border-b border-border bg-muted/30 px-4 py-2 text-xs text-muted-foreground md:px-5", children: [
      error ? /* @__PURE__ */ jsxs("span", { className: "text-destructive", children: [
        "Refresh failed: ",
        error
      ] }) : null,
        ...
        children: [
          /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx(
            "marker",
            {
              ...
              children: /* @__PURE__ */ jsx("path", { d: "M 0 0 L 8 4 L 0 8 z", className: "fill-muted-foreground" })
            }
          ) }),
          /* @__PURE__ */ jsx("g", { "aria-hidden": "true", children: layout.edges.map((edge) => {
